...
export function LinksSection() {
  return (
    <section id="links" className="bg-crust pb-6 pt-20">
      <div className="mx-auto max-w-230 px-7">
        <Reveal>
          <div className="mb-4 flex flex-wrap items-baseline gap-4">
            ...
            <h2 className="bg-gradient-to-r from-pink to-blue bg-clip-text text-[clamp(1.5rem,3.4vw,2.1rem)] font-extrabold text-transparent">
              Find her elsewhere
            </h2>
          </div>
        </Reveal>
