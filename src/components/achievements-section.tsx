...
export function AchievementsSection() {
  return (
    <section
      id="achievements"
      className="snap-page relative flex min-h-dvh flex-col justify-center bg-mantle py-16"
    >
      ...
      <div className="relative z-10 mx-auto max-w-230 px-7">
        <Reveal>
          <div className="mb-4 flex flex-wrap items-baseline gap-4">
            ...
            <h2 className="bg-gradient-to-r from-mauve to-blue bg-clip-text text-[clamp(1.9rem,4.8vw,3rem)] font-extrabold text-transparent">
              Stuff I&apos;m proud of
            </h2>
          </div>
        </Reveal>
